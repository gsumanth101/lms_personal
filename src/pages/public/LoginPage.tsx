      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-500">
            Access your courses, curriculum notes, and learning track
          </p>
        </div>
        ...
        <div className="p-6 md:p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-xl space-y-5">
          ...
          <button
            ...
            disabled={submitting}
            type="button"
            className="w-full py-3 px-4 rounded-xl border border-slate-300 dark:border-slate-700 hover:border-slate-400 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-750 transition flex items-center justify-center gap-3 font-semibold text-sm text-slate-800 dark:text-slate-100 shadow-xs group"
          >
          ...
          <Divider sx={{ my: 2 }}>
            <span className="text-xs text-slate-400 font-medium px-2">or with email</span>
          </Divider>
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <div className="flex items-center justify-between text-xs pt-1">
              ...
              <NavLink to="/forgot-password" className="text-indigo-600 dark:text-indigo-400 hover:underline">
                Forgot password?
              </NavLink>
            </div>
        ...
        <p className="text-center text-xs text-slate-500">
          ...
          <NavLink to="/register" className="font-bold text-indigo-600 dark:text-indigo-400 hover:underline">
            Create an account
          </NavLink>
        </p>
      </div>
